function init() {  
  ...
  const triggerBunnyMessage = (bunny, classToAdd) => {
    bunny.el.setAttribute('message', ['Ooooooh kbidaa!', 'Love u <3', 'Hbiiila', 'Tfooooo', 'Ya L3mmeeer', 'Laykhalik Liyaa', 'Habiiteek '][randomN(7) - 1])
  ...
  setInterval(()=> {
    ...
    elements.bunnyPos.forEach((indicator, i) => {
      ...
      if (bunny) {
        ...
        indicator.innerHTML = `<div class="bunny-indicator" style="transform: rotate(${angle * -1}deg)">${distance - 40} <br>Need Hug</div>`
